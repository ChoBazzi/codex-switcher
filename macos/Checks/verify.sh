...
if command -v codex >/dev/null 2>&1; then
    ...
    SWITCHER_CODEX_INTEGRATION=1 go test -race -count=1 -timeout 90s ./cmd/switcher-helper -run 'TestInstalledProbeParser|TestInstalledProbeTools|TestInstalledProbeCompaction|TestProbe'
else
